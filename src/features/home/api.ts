import type { BaseStreakEntity, RoutineEntity } from '@/features/home/types'
...
const getMockRoutines = (): RoutineEntity[] => {
  const now = new Date()
...
export const fetchHomeData = async (): Promise<HomePageResponse> => {
  return {
    todayRoutine: getMockRoutines(),
    weeklyStreaks: [],
  }
}
