const ar = {
  ...
  'current_box': 'صندوقك الحالي',
  'current_routine': 'روتينك الحالي',
  'download_to_access': 'هذه الميزة تظهر بشكل أفضل في تطبيقنا ✨',
  'download_to_discover': 'اكتشف هذه الميزة داخل تطبيقنا',
  'download_to_me': 'قم بإعداد ملفك الشخصي لفتح توصيات مخصّصة لك.',
  'download_on_app_store': 'التنزيل من App Store',
  'get_it_on_google_play': 'الحصول عليه من Google Play',
